...
def get_settings(guild_id):
  ...
  if row:
    ...
    return {
        ...
        "ticket_status": row.get("ticket_status") or "enabled",
        "ticket_category": row.get("ticket_category") or "",
        "support_role": row.get("support_role") or row.get("ticket_support_role") or "",
        "ticket_archive_channel": row.get("ticket_archive_channel") or "",
        ...
        "text_1": row.get("text_1") if row.get("text_1") is not None else "",
        "text_2": row.get("text_2") if row.get("text_2") is not None else "",
        "text_3": row.get("text_3") if row.get("text_3") is not None else "",
...
def save_settings(guild_id, settings):
  ...
  data_to_save = {
      ...
      "ticket_status": settings.get("ticket_status", "enabled"),
      "ticket_category": str(settings.get("ticket_category", "")),
      "support_role": settings.get("support_role") or settings.get("ticket_support_role", ""),
      "ticket_archive_channel": settings.get("ticket_archive_channel", ""),
      ...
      "text_1": str(settings.get("text_1", "")),
      "text_2": str(settings.get("text_2", "")),
      "text_3": str(settings.get("text_3", "")),
