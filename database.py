...
def get_settings(guild_id):
  ...
  if row:
    ...
    return {
        ...
        "ticket_support_role": row.get("ticket_support_role") or row.get("support_role") or "",
...
def save_settings(guild_id, settings):
  ...
  data_to_save = {
      ...
      "ticket_status": str(settings.get("ticket_status", "enabled")),
      "ticket_category": str(settings.get("ticket_category", "")),
      "ticket_support_role": str(settings.get("ticket_support_role", "")),
      "ticket_archive_channel": str(settings.get("ticket_archive_channel", "")),
