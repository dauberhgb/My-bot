...
async def generate_welcome_card(member, bg_url=None, lang="ar"):
  try:
    ...
    draw.text((text_x + 2, 665), member_count_text, fill=(0, 0, 0, 220), font=font_sub, anchor="ra" if user_lang == "ar" else "la")
    draw.text((text_x, 665), member_count_text, fill=(209, 213, 219), font=font_sub, anchor="ra" if user_lang == "ar" else "la")
