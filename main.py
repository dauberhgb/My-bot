...
async def generate_welcome_card(member, bg_url=None, lang="ar"):
  try:
    ...
    draw.text((text_x + 2, 522), welcome_title, fill=(0, 0, 0, 220), font=font_title, anchor="ra" if user_lang == "ar" else "la")
    draw.text((text_x, 522), welcome_title, fill=(147, 197, 252), font=font_title, anchor="ra" if user_lang == "ar" else "la")

    draw.text((text_x + 2, 319), display_name, fill=(0, 0, 0, 220), font=font_name, anchor="ra" if user_lang == "ar" else "la")
    draw.text((text_x, 319), display_name, fill=(255, 255, 255), font=font_name, anchor="ra" if user_lang == "ar" else "la")

    draw.text((text_x + 2, 729), member_count_text, fill=(0, 0, 0, 220), font=font_sub, anchor="ra" if user_lang == "ar" else "la")
    draw.text((text_x, 729), member_count_text, fill=(209, 213, 219), font=font_sub, anchor="ra" if user_lang == "ar" else "la")
